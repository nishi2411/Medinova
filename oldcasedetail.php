...
$select="select * from old_case join add_case on add_case.case_no = old_case.case_id join patient on patient.pid = add_case.pr_id  join doctor_reg on doctor_reg.dr_id = add_case.ds_id join specialist on specialist.sdr_id = doctor_reg.dr_id join category on category.cid = specialist.c_id  where old_case.oh_id= $hid and  old_case.case_id=$id";
