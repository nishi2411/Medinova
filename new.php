...
<!-- Span-2  -->
    ...
    <select class="form-control" name="ds_id" >
                    ...
                    <div class="form-group" id="fnmae"style="display: none;">
                    <label for="">first name</label>
                    <input type="text" id=""  required placeholder="Enter your first name"  class="form-control" name="fname" onKeyPress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" pattern="[A-Z a-z  ]{3,}" title="Minimum 3 Character Required">
                  </div>
