...
//   $cpass=$_REQUEST['cpass'];
  ...
  $insert="insert into patient values (null,'$fname','$mname','$lname','$mobile','$email',
  '$mobile','$mobile','$bg','$dob','$gender')";
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
     <section class="content">
      ...
      <div class="form-group">
                    ...
                    <input type="text" id="fname"  placeholder="Enter your first name"  class="form-control" name="fname" onKeyPress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" pattern="[A-Z a-z  ]{3,}" title="Minimum 3 Character Required">
                  </div>
               
                  <div class="form-group">
                <label for="">Middle name</label>
                <input type="text" id="mname"  placeholder="Enter your middle name" class="form-control" name="mname"onKeyPress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" pattern="[A-Z a-z  ]{3,}" title="Minimum 3 Character Required">
                  </div>

                <div class="form-group">
                <label for="">Last name</label>
                <input type="text" id="lname"  placeholder="Enter your last name" class="form-control" name="lname" onKeyPress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" pattern="[A-Z a-z  ]{3,}" title="Minimum 3 Character Required">
                  </div>
                
                    <div class="form-group">
                <label for="">Mobile No</label>
                    <input type="number" name="mobile" class="form-control" id="certi" >
                  </div>
      ...
      <div class="form-group ">
       <b> <label for="date">Birth Date</label></b>
        <input type="date" id="date" placeholder="Select your date" name="dob"  class="form-control">
      </div>
      <div class="form-group ">
    ...
    <select class="form-control" name="ds_id" >
                ...
                <div id="sid">
                  ...
                  <input type="submit" class="btn btn-primary" id="btn1" name="btn_suc"></div>
            </div>
            </form>
